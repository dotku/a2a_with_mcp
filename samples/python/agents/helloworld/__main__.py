...
if __name__ == '__main__':
    ...
    currency_skill = AgentSkill(
        ...
        description='Converts US Dollars to Indian Rupees using approximate exchange rates',
        tags=['currency', 'conversion', 'USD', 'INR', 'exchange rate'],
        examples=[
            'how much is 10 USD in INR?',
            'convert 50 USD to INR',
            'what is 100 dollars in rupees?',
            '25 USD in Indian rupees'
        ],
    )
    # --8<-- [end:AgentSkill]
    ...
    public_agent_card = AgentCard(
        ...
        skills=[skill, currency_skill],  # Only the basic skill for the public card
